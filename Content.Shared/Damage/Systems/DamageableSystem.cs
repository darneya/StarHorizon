...
namespace Content.Shared.Damage
{
    public sealed class DamageableSystem : EntitySystem
    {
        ...
        public DamageSpecifier? TryChangeDamage(EntityUid? uid, DamageSpecifier damage, bool ignoreResistances = false,
            bool interruptsDoAfters = true, DamageableComponent? damageable = null, EntityUid? origin = null, EntityUid? tool = null) // HORIZON TWEAK
        {
    ...
    public sealed class DamageModifyEvent : EntityEventArgs, IInventoryRelayEvent
    {
        ...
        public DamageModifyEvent(DamageSpecifier damage, EntityUid? origin = null, EntityUid? tool = null) // HORIZON TWEAK
        {
            OriginalDamage = damage;
            Damage = damage;
            Origin = origin;
            Tool = tool; // HORIZON TWEAK
        }
    }
