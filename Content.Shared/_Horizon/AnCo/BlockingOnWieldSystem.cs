...
public sealed class BlockingOnWieldSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BlockingOnWieldComponent, ItemWieldedEvent>(OnWielded);
        SubscribeLocalEvent<BlockingOnWieldComponent, ItemUnwieldedEvent>(OnUnwielded);
    }

    private void OnWielded(EntityUid uid, BlockingOnWieldComponent component, ref ItemWieldedEvent args)
    {
    ...
    private void OnUnwielded(EntityUid uid, BlockingOnWieldComponent component, ref ItemUnwieldedEvent args)
    {
        if (!_timing.IsFirstTimePredicted)
            return;
