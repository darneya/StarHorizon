...
Это репозиторий русскоязычного сервера по Space Station 14, **Aavikko Avaruus**, целью которого является перенос механник из SS13, а так же добавление своих собственных механник.
...
2. Запустите `RUN_THIS.py`. `cd Aavikko`, `python ./RUN_THIS.py` [Ссылка на официальный сайт для скачивания Python](https://www.python.org/downloads/)
...
3. Если вы хотите применять наш код в своем проекте, то помимо требований, предъявляемых лицензией AGPLv3, **вы обязаны** в вашем сообществе (Дискорд) в Чейндлогах указать ссылку на наше сообщество (Дискорд). Ссылка: https://discord.gg/a9wg5TFS.
