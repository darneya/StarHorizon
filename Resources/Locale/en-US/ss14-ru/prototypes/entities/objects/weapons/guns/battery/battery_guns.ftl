...
ent-WeaponTaser = taser
    .desc = A low-capacity, energy-based stun gun used by security teams to subdue targets at close range. On the handle is a label that says 'for authorized use only.'
