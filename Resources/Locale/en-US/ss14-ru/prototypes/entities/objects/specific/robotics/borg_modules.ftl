...
ent-BorgModuleSyndicateLaser = syndicate laser module
    .desc = Advanced laser module for Syndicate operatives. Highly effective weapon system.
ent-BorgModuleSyndicateHeavyLaser = syndicate heavy laser module
    .desc = Advanced heavy laser module with significantly increased firepower. Devastating against armored targets.
ent-BorgModuleSyndicateCloakingDevice = syndicate cloaking device module
    .desc = Integrated cloaking device for stealth operations. Renders the operative invisible for extended periods.
...
ent-BorgModuleCombatPKA = kinetic accelerator cyborg module
    .desc = A module equipped with a kinetic accelerator for rapid fire combat.
ent-BorgModuleCombatEchis = pistol cyborg module
    .desc = A module equipped with a compact energy pistol for precise combat operations.
ent-BorgModuleCombatLaserAdvanced = advanced laser pistol cyborg module
    .desc = A module equipped with an advanced laser pistol for superior firepower.
ent-BorgModuleCombatPKAHeavy = heavy kinetic cannon cyborg module
    .desc = A module equipped with a heavy kinetic cannon for devastating close-range attacks.
ent-BorgModuleCombatPKARailgun = kinetic railgun cyborg module
    .desc = A module equipped with a kinetic railgun for armor-piercing attacks.
ent-BorgModuleCombatPKARepeater = kinetic repeater cyborg module
    .desc = A module equipped with a kinetic repeater for sustained automatic fire.
ent-BorgModuleCombatPKAShotgun = kinetic shotgun cyborg module
    .desc = A module equipped with a kinetic shotgun for devastating close-range spread fire.
ent-BorgModuleCombatL6C = GSW LMG-6 cyborg module
    .desc = A module equipped with the GSW LMG-6 light machine gun for sustained fire support.
ent-BorgModuleCombatLaserHeavy = heavy laser cyborg module
    .desc = A module equipped with a heavy laser system providing massive destructive power.
ent-BorgModuleCombatCloakingDevice = cloaking device module
    .desc = Integrated cloaking device for stealth operations. Renders the operative invisible for extended periods.
ent-BorgModuleTranslation = translation cyborg module
    .desc = A module equipped with universal translation technology for communication across languages.
