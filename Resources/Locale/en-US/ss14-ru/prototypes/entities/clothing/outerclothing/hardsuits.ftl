...
ent-ClothingOuterHardsuitMedical = chief medical officer's hardsuit
    .desc = A special suit that protects against hazardous, low pressure environments. Built with lightweight materials for easier movement. Cut-resistant alloys provide substantial resistance against infectious bites.
...
ent-ClothingOuterHardsuitSyndieMedic = blood-red medic hardsuit
    .desc = A heavily armored and agile advanced hardsuit specifically designed for field medic operations. Cut-resistant alloys provide substantial protection against infectious bites.
