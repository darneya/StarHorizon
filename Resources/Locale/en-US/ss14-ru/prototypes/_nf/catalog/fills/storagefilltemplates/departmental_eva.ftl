...
ent-StorageFillEVASuitFsa = { "" }
    .desc = Contains a standard issue Far Star Arms (FSA) EVA suit.
ent-StorageFillEVASuitFsb = { "" }
    .desc = Contains a standard issue Far Star Biotech (FSB) EVA suit.
ent-StorageFillEVASuitFsc = { "" }
    .desc = Contains a standard issue Far Star Commerce (FSC) EVA suit.
