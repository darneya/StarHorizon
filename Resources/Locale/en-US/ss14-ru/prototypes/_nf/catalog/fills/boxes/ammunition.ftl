...
ent-NFBoxMagazinePistolSubMachineGun35Overpressure = box of SMG (.35 pistol, overpressure) magazines
    .desc = A box full of SMG (.35 pistol, overpressure) magazines.
ent-NFBoxMagazineTopMountedSubMachineGun35Overpressure = box of top-mounted SMG (.35 pistol, overpressure) magazines
    .desc = A box full of top-mounted SMG (.35 pistol, overpressure) magazines.
