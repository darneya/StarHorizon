ent-NFBaseClothingNeckCard = { ent-RecyclableItemPlasticTiny }
    .desc = { ent-RecyclableItemPlasticTiny.desc }
ent-NFClothingNeckCardReporter = reporter card
    .desc = A press pass identifying the bearer as a member of the news media.
