...
ent-ClothingHeadHardsuitHostileEnvironment = hostile environment hardsuit helmet
    .desc = Thermally sealed helmet with 360 degree lighting to get you and your crew through the darkest and most deadly of places.
ent-ClothingHeadHardsuitSurplus = surplus combat suit helmet
    .desc = Not stopping a bullet, but better then nothing!
ent-ClothingHeadHardsuitNoble = noble combat suit helmet
    .desc = The noble eye watches not in anger, but in vigilance. Let no shadow pass unseen and no evil go unchallenged.
