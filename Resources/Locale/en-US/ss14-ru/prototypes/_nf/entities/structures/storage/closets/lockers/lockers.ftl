...
ent-ClosetFsaEva = FSA EVA suit locker
    .desc = It's a storage unit that could contain a Far Star Arms EVA suit. It may also contain other things.
...
ent-ClosetFscEva = FSC EVA suit locker
    .desc = It's a storage unit that could contain a Far Star Commerce EVA suit. It may also contain other things.
