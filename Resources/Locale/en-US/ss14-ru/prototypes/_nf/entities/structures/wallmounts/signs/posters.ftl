...
ent-NFPosterContrabandFsbNightlight = Far Star Commerce Nightlight
    .desc = The FSC Nightlight, chasing the night away.
ent-NFPosterContrabandFsbRetort = Far Star Commerce Retort
    .desc = The FSC Retort! Ignite your potential!
...
ent-NFPosterContrabandFscLogo = Far Star Commerce Logo
    .desc = Far Star Commerce: You can't spell adventure without venture capital.'
ent-NFPosterContrabandFscSurveyor = Far Star Commerce Surveyor
    .desc = The FSC Surveyor, there's no better choice when you're out of options.
ent-NFPosterContrabandFscCourier = Far Star Commerce Courier
    .desc = The FSC Courier, delivering the stars.
ent-NFPosterContrabandFsbDruid = Far Star Biotech Druid
    .desc = The FSB Druid, growing worlds one egg at a time.
ent-NFPosterContrabandGas = Group for Atmos Shenanigans
    .desc = The frezon must flow.
ent-NFPosterContrabandCloudWatchers = Cloud Watchers
    .desc = Every asteroid belt hides a lil guy.
ent-NFPosterContrabandGoblinLeague = Goblin League
    .desc = Stop a cousin and ask about the Goblin League today!
ent-NFPosterContrabandEms = Emergency Medical Society
