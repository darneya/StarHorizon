ent-SpawnDungeonLootClutterEngi = random clutter
    .suffix = Loot (Frontier), Engineering, Safe
    .desc = { ent-MarkerBasePlaceFree.desc }
ent-SpawnDungeonLootClutterEngiWithMines = random clutter
    .suffix = Loot (Frontier), Engineering, Unsafe (mines)
    .desc = { ent-MarkerBasePlaceFree.desc }
...
ent-SpawnDungeonLootToolbox = random toolbox
    ...
    .desc = { ent-MarkerBasePlaceFree.desc }
ent-SpawnDungeonLootEngineeringRipleyDisassembled = disassmebled Ripley APLU
    .suffix = Loot (Frontier)
    .desc = { ent-MarkerBasePlaceFree.desc }
