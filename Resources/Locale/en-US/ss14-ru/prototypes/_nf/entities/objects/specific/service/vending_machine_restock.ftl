...
ent-VendingMachineRestockAutoTuneVend = AutoTune restock box
    .desc = A box containing music and stuff for the AutoTune machine. A label reads "THE BOX IS TAMPER-PROOF AND WILL DESTROY ITS CONTENT ON HARM."
