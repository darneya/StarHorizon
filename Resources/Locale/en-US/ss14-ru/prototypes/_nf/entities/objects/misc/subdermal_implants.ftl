ent-NFBaseDeathRattleImplant = death rattle implant
...
ent-NFSDTrackingImplant = nfsd tracking implant
...
ent-WehImplant = weh implant
    .desc = This implant lets the user weh anywhere at any time.
