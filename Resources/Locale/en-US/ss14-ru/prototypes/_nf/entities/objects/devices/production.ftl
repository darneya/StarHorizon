ent-CargoTechFabCircuitboardNF = cargo techfab machine board
...
ent-GaslockFrameMachineCircuitboard = portable gaslock machine board
    .desc = A machine printed circuit board for a gas mining drill.
ent-OreProcessorCivilianCircuitboard = civilian ore processor machine board
    .desc = A machine printed circuit board for a civilian ore processor.
ent-NfsdTechFabCircuitboard = NFSD techfab machine board
    .desc = A machine printed circuit board for an NFSD techfab.
ent-PirateTechFabCircuitboardNF = pirate techfab machine board
    .desc = A machine printed circuit board for a pirate techfab.
...
ent-ScrollWizardStaffRechargerAltar = wizard staff altar binding scroll
    .desc = An odd amalgamation of wizardry and circuitry. Somehow it has a number of ports matching a standard NanoTrasen machine frame.
ent-ScrollCultStaffRechargerAltar = blood cult staff altar binding scroll
    .desc = An odd amalgamation of eldritch magic and circuitry. Somehow it has a number of ports matching a standard NanoTrasen machine frame.
ent-ScrollCultForge = cult forge binding scroll
