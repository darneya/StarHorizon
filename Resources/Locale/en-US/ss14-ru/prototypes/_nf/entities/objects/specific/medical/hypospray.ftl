...
ent-EphedrineAutoInjector = ephedrine auto-injector
...
ent-AmbuzolAutoInjector = ambuzol auto-injector
    .desc = Ambuzol prepared as a preventative measure for mercenaries encountering zombies in combat.
ent-AmbuzolPlusAutoInjector = ambuzol plus auto-injector
    .desc = When preventative Ambuzol is not enough, Ambuzol Plus will clean up what's left.
