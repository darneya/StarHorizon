...
ent-MachineMiniAnomalyGeneratorFlatpack = mini anomaly generator flatpack
    .desc = A flatpack used for constructing a mini anomaly generator.
...
ent-ComputerWithdrawBankATMFlatpack = withdraw-only bank ATM flatpack
...
ent-CivilianOreProcessorFlatpack = civilian ore processor flatpack
    .desc = A flatpack used for constructing a civilian ore processor.
...
ent-CargoTechfabNFFlatpack = cargo techfab flatpack
    .desc = A flatpack used for constructing a cargo techfab.
ent-CrateStorageRackFlatpack = crate storage rack flatpack
    .desc = A storage rack prefab.
...
ent-MercenaryTechFabHackedFlatpack = hacked mercenary techfab flatpack
    .desc = A flatpack used for constructing a hacked mercenary techfab.
ent-PirateTechFabFlatpack = pirate techfab flatpack
    .desc = A flatpack used for constructing a pirate techfab.
