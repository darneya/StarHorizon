...
ent-NFBaseWeaponFrameEnergyPistolFrontierGunsmith = { ent-NFBaseWeaponFrameEnergyPistol }
    .desc = { ent-NFBaseWeaponFrameEnergyPistol.desc }
ent-NFBaseWeaponFrameEnergyPistolPowerCell = { ent-NFBaseWeaponEncumbrancePistol }
    .suffix = Frontier
    .desc = { ent-NFBaseWeaponEncumbrancePistol.desc }
ent-NFBaseWeaponFrameEnergyPistolNanotrasenPowerCell = { ent-NFBaseWeaponFrameEnergyPistolPowerCell }
    .desc = { ent-NFBaseWeaponFrameEnergyPistolPowerCell.desc }
