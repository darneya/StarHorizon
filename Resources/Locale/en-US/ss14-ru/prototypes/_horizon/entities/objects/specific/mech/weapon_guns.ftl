...
ent-MechGunCryo = cryogun
    .desc = An experimental weapon that uses cold energy against its target.
ent-MechGunPyro = pyrogun
    .desc = An experimental weapon that uses concentrated pyrokinetic energy against its target.
