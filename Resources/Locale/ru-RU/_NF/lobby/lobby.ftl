...
frontier-lobby-pirate-subtext = Здесь слышен звон пиастров, а ром вечен.
frontier-lobby-pirate-description = Это идеальное убежище, где собираются подонки, ублюдки и просто пираты. Здесь вы можете:
 ...
 Некоторые роли на этой станции доступны только по белому списку. Чтобы попасть в белый список, обратитесь в Discord.
frontier-lobby-medical-subtext = Медицинский диспетчерский центр Фронтира.
...
frontier-lobby-edison-subtext = Место, где общаются механики.
frontier-lobby-edison-description = Тяжёлая промышленная база Фронтира. Здесь вы можете:
 ...
 {"["}color=gray]Некоторые вакансии на этой станции доступны только [color=lightblue]из белого списка[/color] и требуют подачи заявки в Discord.[/color]
