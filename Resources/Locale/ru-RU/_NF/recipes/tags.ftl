...
construction-graph-tag-shell-shotgun = ружейный патрон
construction-graph-tag-flare = сигнальная ракета
construction-graph-tag-medal = медаль
construction-graph-tag-whoopie-cushion = подушка-пердушка
construction-graph-tag-material-hide-rosy-mothroach = шкура розового мотылектаракана
construction-graph-tag-freezer-electronics-circuit-board = плата электроники морозильника
