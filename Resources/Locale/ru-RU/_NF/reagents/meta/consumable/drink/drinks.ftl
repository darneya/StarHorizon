...
reagent-name-nanocoldbrew = холодный кофе
reagent-desc-nanocoldbrew = Идеально, когда день жаркий, а стандарты — низкие.
reagent-name-nanodepresso = депрессо
reagent-desc-nanodepresso = Как эспрессо, если бы он просто не старался и позволил своим возможностям ускользнуть мимо. Напиток для вас.
reagent-name-coftea = кофтай
reagent-desc-coftea = Изобретено кем-то, кто перепутал кнопку чая с кнопкой кофе. Или наоборот.
