...
trait-monochromacy-name = Монохроматия
trait-monochromacy-desc = Вы абсолютно не различаете цвета, все, что вы воспринимаете, варьируется от черного до белого.
...
trait-hemophilia-desc = У вас не образуется тромбов, и вы можете умереть от незначительных порезов.
trait-impaired-mobility-name = Ограничение подвижности
trait-impaired-mobility-desc = У вас возникают трудности с передвижением без вспомогательного устройства.
