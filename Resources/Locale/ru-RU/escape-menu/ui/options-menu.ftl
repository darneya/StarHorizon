...
ui-options-bwoink-sound = Проигрывать звуки Ахелпа
...
ui-options-header-text-other = Ввод текста (другой)
...
ui-options-function-laying = Лежать
...
ui-options-function-swap-hands = Поменять руки (следующее)
...
ui-options-speech-bubble-text-opacity = Прозрачность текста речевого пузырька
ui-options-speech-bubble-speaker-opacity = Прозрачность динамика речевого пузырька
ui-options-speech-bubble-background-opacity = Прозрачность фона речевого пузырька
...
ui-options-function-text-backspace = Удалить символ слева (Backspace)
ui-options-function-text-delete = Удалить символ справа (Delete)
...
ui-options-admin-playerlist-separate-symbols = Показывать отдельные символы для каждого типа антагонистов
ui-options-admin-playerlist-character-color = Окрашивать имена персонажей-антагонистов
ui-options-admin-playerlist-roletype-color = Окрашивать типы ролей
ui-options-enable-overlay-nf-balance = Отображать баланс
...
ui-options-overlay-merge-distance = Дистанция объединения в стопки
