...
currency-exchange-window-title = Обмен валюты
currency-exchange-current-rate = Текущий курс:
currency-exchange-commission = Комиссия:
currency-exchange-rate-history = История курса
currency-exchange-disk-info = Информация о диске
currency-exchange-disk-credits = Ендов на диске:
currency-exchange-will-receive = Вы получите:
currency-exchange-amount = Количество:
currency-exchange-button-exchange = Обменять
