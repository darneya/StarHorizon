...
ent-ClothingBackpackDuffelSyndicateFilledRailAttachments = набор модулей для верхней планки
    .desc = Набор тактических модулей для установки на верхнюю планку оружия. Включает оптический прицел, магнитный ремень и лазерный целеуказатель.
...
ent-ClothingBackpackDuffelSyndicateFilledUnderAttachments = набор подствольных модулей
    .desc = Комплексный набор подствольного оборудования. Включает вертикальную рукоять, коллиматорный прицел, подствольный дробовик US90 и подствольный гранатомёт GL90.
