...
ent-ClothingMaskGasBlueshield = противогаз DFI
    .desc = Специальный противогаз для офицеров DFI. Имеет не только бронепластины и светофильтрующее покрытие, но и вас.
    .suffix = StarHorizon
