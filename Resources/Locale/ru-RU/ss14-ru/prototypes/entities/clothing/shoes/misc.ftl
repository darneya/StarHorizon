...
ent-ClothingShoesBootsJump = прыжковые ботинки
    .desc = Высокотехнологичные ботинки, которые дают вам невероятную способность ПРЫГАТЬ! В этих ботинках вы можете прыгать через лаву, пропасти и странные химикаты на полу!
