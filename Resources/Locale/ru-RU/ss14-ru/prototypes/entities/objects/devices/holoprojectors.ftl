...
ent-HoloprojectorBorg = { ent-Holoprojector }
    .suffix = Борг
    .desc = { ent-Holoprojector.desc }
ent-HoloprojectorClownBorg = голокожурный проектор
    .desc = Голокожурный проектор, создающий скользкую, твёрдую световую банановую кожуру. Перезаряжается, так что веселье никогда не заканчивается!
    .suffix = Борг
