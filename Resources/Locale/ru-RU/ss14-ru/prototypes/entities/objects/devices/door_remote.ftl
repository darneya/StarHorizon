...
ent-DoorRemoteCustom = настраиваемый пульт от шлюзов
    .desc = Гаджет, позволяющий дистанционно открывать и болтировать двери. Эта продвинутая версия не имеет встроенных прав доступа, а вместо этого наследует ID-права пользователя.
