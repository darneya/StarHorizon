...
ent-WeaponTaserSuper = элитный тазер
    .desc = Электрошокер малой емкости, работающий на основе энергии, используемый элитными подразделениями безопасности для обезвреживания даже самых сложных целей.
    .suffix = АДМЕМ
