...
ent-ActionGravityJump = Прыгнуть
    .desc = Активация усовершенствованной системы пропульсии позволяет вам переместиться на короткое расстояние в направлении вашего взгляда.
ent-ActionChameleonController = Контроллер хамелеона
    .desc = Измените весь свой наряд быстро!
