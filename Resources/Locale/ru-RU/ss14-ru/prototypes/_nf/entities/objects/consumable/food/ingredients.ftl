...
ent-FoodCoffee = сырые кофейные зёрна
    .desc = Зелёные кофейные зёрна, ждущие обжарки.
...
ent-FoodRiceDough = рисовое тесто
    .desc = Ты уверен, что это просто рис и вода. Ты понятия не имеешь, как это держится вместе.
ent-FoodRiceDoughSlice = ломтик рисового теста
    .desc = Ломтик рисового теста.
ent-FoodSausageRaw = сырая колбаса
    .desc = Простая колбаса. Кто знает, что в неё положили?
ent-FoodSausageCasing = оболочка для колбасы
    .desc = Кишка или что-то эквивалентное какого-то бедного создания...
