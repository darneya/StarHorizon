...
ent-EphedrineAutoInjector = медипен эфедрина
    .desc = Быстрая доза стимуляторов для повышения ловкости и двигательной активности.
...
ent-AmbuzolAutoInjector = медипен амбузола
    .desc = Амбузол, подготовленный в качестве профилактической меры для наёмников, сталкивающихся с зомби в бою.
ent-AmbuzolPlusAutoInjector = медипен амбузола плюс
    .desc = Когда профилактического амбузола недостаточно, амбузол плюс разберётся с остальным.
