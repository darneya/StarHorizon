...
ent-NonLethalVendingMachinePOI = { ent-BaseStructureDisableAnchoring }
    .suffix = POI
...
ent-NFVendingMachineMagivend = { ent-BaseC3WizardContraband }
    .suffix = Фронтир
    .desc = { ent-BaseC3WizardContraband.desc }
ent-VendingMachineMagivendConjured = призванный МагМазин
    .desc = Волшебный торговый автомат, созданный с помощью магии. Он скоро исчезнет.
