...
ent-NFHolopadShipAntag = { ent-NFHolopadShip }
    ...
    .suffix = Шаттл, Антаг
ent-NFHolopadGrid = внутрикорабельный голопад
    .desc = Напольное устройство для проецирования голографических изображений, обеспечивающее связь внутри корабля.
    .suffix = Локальный
