...
ent-ClothingBackpackDuffelInterdyneCBURNHardsuitBundle = вещьмешок экзоскафандра CBURN Interdyne
    .desc = Содержит экзоскафандр CBURN Interdyne для любителей биологического оружия
ent-ClothingBackpackDuffelSyndicateFilledSunfire = Набор Солнцепёка
    .desc = Да сгинут враги синдиката в адском пламени термобарического снаряда
...
ent-ClothingBackpackDuffelAcolyteBundle = набор брони аколита
    .desc = Содержит броню аколита, обязательную часть любого лидера культа.
