...
reagent-desc-artifact-glue = Смесь клея и артифексиума. Может восстанавливать прочность узлов в артефакте при прикосновении.
...
reagent-desc-lye = Полупрозрачный, оранжевый щелочной раствор, используемый в традиционном производстве мыла.
