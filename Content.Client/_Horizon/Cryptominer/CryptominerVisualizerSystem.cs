...
public sealed class CryptominerVisualizerSystem : VisualizerSystem<CryptominerComponent>
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CryptominerComponent, AnimationCompletedEvent>(OnAnimationCompleted);
    }

    protected override void OnAppearanceChange(EntityUid uid, CryptominerComponent component, ref AppearanceChangeEvent args)
    {
        if (args.Sprite == null)
            return;
    ...
    private void HandleVentState(EntityUid uid, SpriteComponent sprite, CryptominerState state, bool isVentOpen, CryptominerComponent component)
    {
    ...
    private void OnAnimationCompleted(EntityUid uid, CryptominerComponent component, AnimationCompletedEvent args)
    {
