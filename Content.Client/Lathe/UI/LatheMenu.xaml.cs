...
public sealed partial class LatheMenu : DefaultWindow
{
    ...
    public event Action<bool>? InfiniteProductionToggled;
    ...
    public LatheMenu()
    {
        ...
        InfiniteButton.ToggleMode = true; // Делает кнопку переключаемой
        InfiniteButton.OnToggled += args => InfiniteProductionToggled?.Invoke(args.Pressed);
    }
