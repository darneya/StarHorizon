...
public sealed class SoulCuttingMaskSystem : EntitySystem
{
    ...
    private void AddMaskVerbs(EntityUid maskUid, SoulCuttingMaskComponent maskComp, GetVerbsEvent<Verb> args)
    {
        ...
        Verb setHostVerb = new Verb
        {
            ...
            Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/takemask.png"))
        };
        ...
        if (maskComp.OwnerUid == args.User)
        {
            Verb saveVerb = new Verb
            {
                ...
                Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/activatemask.png"))
            };
            ...
            if (maskComp.MaskSealed)
            {
                Verb removeVerb = new Verb
                {
                    ...
                    Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/deactivatemask.png"))
                };
