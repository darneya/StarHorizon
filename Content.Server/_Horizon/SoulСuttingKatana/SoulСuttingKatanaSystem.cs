...
using Content.Shared._Horizon.SoulСuttingKatana;
using Content.Shared.Mobs;
using Content.Shared.Weapons.Reflect;

namespace Content.Server._Horizon.SoulСuttingKatana;
...
public sealed class SoulCuttingKatanaSystem : EntitySystem
{
    ...
    private void AddKatanaVerbs(EntityUid katanaUid, SoulCuttingKatanaComponent katanaComp, GetVerbsEvent<Verb> args)
    {
        ...
        Verb setOwnerVerb = new Verb
        {
            ...
            Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/takekatana.png"))
        };
        ...
        if (katanaComp.OwnerUid == args.User)
        {
            Verb activateVerb = new Verb
            {
                ...
                Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/activatekatana.png"))
            };
            ...
            if (katanaComp.IsActive)
            {
                Verb deactivateVerb = new Verb
                {
                    ...
                    Icon = new SpriteSpecifier.Texture(new("/Textures/_Horizon/Interface/Actions/VerbKatana/deactivatekatana.png"))
                };
