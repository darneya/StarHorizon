...
namespace Content.Server._Horizon.SponsorManager
{
    public sealed class SponsorManager
    {
        ...
        private int CalculateSlots(string discordId)
        {
            ...
            {
                "1275161485865259058" => 2,
                "1275161707701993547" => 5,
                "1275162459791167610" => 15,
                "1275162570705080393" => 20,
                "1275163000533291078" => 20,
                "1275163083177988249" => 20,
                _ => 0
            };
        }
        ...
        private int CalculateTokens(string discordId)
        {
            ...
            {
                "1275161707701993547" => 5,
                "1275162459791167610" => 10,
                "1275162570705080393" => 15,
                "1275163000533291078" => 20,
                "1275163083177988249" => 50,
                _ => 0
            };
        }
        #endregion Discord
