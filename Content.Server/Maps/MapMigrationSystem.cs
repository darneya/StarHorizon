...
#pragma warning restore CS0414
    ...
    private static readonly string[] MigrationFiles = { "/migration.yml", "/nf_migration.yml", "/sh_migration.yml", "/rage_migration.yml" }; // Frontier: use array of migration files
