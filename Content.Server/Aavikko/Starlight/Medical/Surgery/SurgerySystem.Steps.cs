...
using Content.Shared.Aavikko.Starlight.Medical.Surgery.Effects.Step;
using Content.Shared.Aavikko.Starlight.Medical.Surgery.Events;
using Content.Shared.Aavikko.Starlight.Medical.Surgery.Steps.Parts;
...
using Content.Shared.Aavikko.Starlight;
using Content.Shared.Humanoid.Prototypes;
using Content.Shared.Interaction.Components;
using Microsoft.CodeAnalysis;

namespace Content.Server.Aavikko.Starlight.Medical.Surgery;
